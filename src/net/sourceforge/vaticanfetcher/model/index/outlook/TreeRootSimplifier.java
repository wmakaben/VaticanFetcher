...
abstract class TreeRootSimplifier<E> {
	...
	// TODO test
	/** For the given tree root, returns a new tree root further down the tree so that empty nodes and branches in between are omitted. */
	@NotNull
	...
	/** Returns true if the given node has content and/or has at least one direct or indirect child that has content. Returns false otherwise. */
