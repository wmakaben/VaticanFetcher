...
import net.sourceforge.vaticanfetcher.model.MailResource;
...
import net.sourceforge.vaticanfetcher.model.parse.HtmlParser;
import net.sourceforge.vaticanfetcher.model.parse.PagingPdfParser;
...
import net.sourceforge.vaticanfetcher.model.parse.PdfParser;
import net.sourceforge.vaticanfetcher.model.parse.TextParser;
...
/**
 * thread-safe class
 * throws UnsupportedOperationException if file methods are called on an email object and vice versa.
 */
@ThreadSafe
public final class ResultDocument {
	...
	public ResultDocument(	@NotNull Document luceneDoc, float score, @NotNull Query query,	boolean isPhraseQuery,
							@NotNull IndexingConfig config, @NotNull FileFactory fileFactory, @NotNull OutlookMailFactory mailFactory) {
	...
	// should be run in a thread
	public void readPdfPages(@NotNull final PdfPageHandler pageHandler) throws ParseException, FileNotFoundException,
	...
	/**
	 * If the receiver represents a file, this method returns a {@code File} for it, wrapped in a {@code FileResource}. The 
	 * caller <b>must</b> dispose of the FileResource after usage. The disposal is necessary since the returned {@code File} 
	 * may represent a temporary file that was extracted from an archive and therefore needs to be disposed of after usage.
	 * <p>
	 * This operation may take a long time, so it should be run in a non-GUI thread.
	 */
	@NotNull
	...
	/**
	 * If the receiver represents an email, this method loads the email contents from disk and returns it 
	 * as a {@code MailResource}. The caller <b>must</b> dispose of the MailResource after usage.
	 * <p>
	 * This operation may take a long time, so it should be run in a non-GUI thread.
	 */
	@NotNull
