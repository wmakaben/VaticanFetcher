...
import net.sourceforge.vaticanfetcher.util.ClassPathHack;
...
public enum Msg {
	...
	close ("&Close",
		...
		"case indicates that the user can activate the button by pressing Alt + C."),
	hotkey_in_use (
		"The hotkey {0} VaticanFetcher tried to register seems to be already in use. " +
	...
	multiple_vaticanfetcher_jars (
		"These files were found inside the VaticanFetcher folder:\n{0}\n\n" +
		"This indicates that multiple VaticanFetcher versions were installed or " +
		...
		"VaticanFetcher into a new, empty folder.",
		"An error message that is shown during startup if it seems as if the " +
		"user has installed or unpacked multiple VaticanFetcher instances on top " +
		"of one another."),
	...
	confirm_text_ext (
		...
		"This will override VaticanFetcher's built-in support for files with " +
	...
	confirm_zip_ext (
		...
		"VaticanFetcher's built-in support for files with these extensions, and " +
		"VaticanFetcher will instead try to process them as zip archives.\n\nThis is " +
	...
	out_of_memory_instructions ("VaticanFetcher has run out of memory. " +
