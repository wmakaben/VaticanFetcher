...
public final class ManualLocator {
	...
	public static final String manualFilename = "VaticanFetcher_Manual.html";
	...
	public static File getManualFile() {
		...
		if (SystemConf.Bool.IsDevelopmentVersion.get())
			...
			helpDirParent = "/usr/share/doc/vaticanfetcher";
		else
	...
	public static File getManualSubpageFile(@NotNull String htmlFilename) {
		...
		String path = Util.joinPath(parentPath, "VaticanFetcher_Manual_files/" + htmlFilename);
