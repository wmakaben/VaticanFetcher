...
import net.sourceforge.vaticanfetcher.enums.SettingsConf.FontDescription;
...
public final class UtilGui {
	...
	/**
	 * Paints a border around the given Control. This can be used as a replacement for the ugly native 
	 * border of Composites with SWT.BORDER style on Windows with classic theme turned on.
	 */
	...
	/** Attaches a focus listener to the given StyledText that clears the selection and resets the caret position when the StyledText looses focus. */
	...
	public static void setGridData(@NotNull Control control, boolean grabExcessVerticalSpace) {
		control.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, grabExcessVerticalSpace));
	}
	
	public static void showOutOfMemoryMessage(@NotNull final Control control,	@NotNull CheckedOutOfMemoryError e) {
		showOutOfMemoryMessage(control, e.getOutOfMemoryError());
	}
	
	public static void showOutOfMemoryMessage(@NotNull final Control control, @NotNull OutOfMemoryError e) {
		Util.printErr(e);
