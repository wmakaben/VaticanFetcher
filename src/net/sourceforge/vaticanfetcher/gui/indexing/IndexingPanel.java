...
import net.sourceforge.vaticanfetcher.model.index.Task;
import net.sourceforge.vaticanfetcher.model.index.DelegatingReporter.ExistingMessagesHandler;
import net.sourceforge.vaticanfetcher.model.index.IndexingQueue.ExistingTasksHandler;
...
import net.sourceforge.vaticanfetcher.util.gui.DropDownMenuManager;
import net.sourceforge.vaticanfetcher.util.gui.MenuAction;
import net.sourceforge.vaticanfetcher.util.gui.TabFolderFactory;
import net.sourceforge.vaticanfetcher.util.gui.ToolItemFactory;
		...
		tabFolder.addCTabFolder2Listener(new CTabFolder2Adapter() {
			public void close(final CTabFolderEvent event) {
				if (tabFolder.getItemCount() == 1) {
					 ...
					 * is closed automatically. If the user does that, there will be the strange effect of VaticanFetcher asking for 
