...
import net.sourceforge.vaticanfetcher.util.gui.viewer.ColumnEditSupport;
import net.sourceforge.vaticanfetcher.util.gui.viewer.ColumnEditSupport.ComboEditSupport;
import net.sourceforge.vaticanfetcher.util.gui.viewer.ColumnEditSupport.TextEditSupport;
import net.sourceforge.vaticanfetcher.util.gui.viewer.SimpleTableViewer;
import net.sourceforge.vaticanfetcher.util.gui.viewer.SimpleTableViewer.Column;
