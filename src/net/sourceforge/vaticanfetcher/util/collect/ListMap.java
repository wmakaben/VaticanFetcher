...
public final class ListMap<K, V> implements Iterable<Entry<K, V>> {
	...
	@NotNull
	public static <K, V> ListMap<K, V> create() { return new ListMap<K, V>(); }
	
	@NotNull
	public static <K, V> ListMap<K, V> create(int size) { return new ListMap<K, V>(size); }
	
	private final List<Entry<K, V>> list;
	
	private ListMap() { list = new ArrayList<Entry<K, V>>(); }
	
	private ListMap(int size) { list = new ArrayList<Entry<K, V>>(size); }
	...
	/** Returns the value of the <b>first</b> occurrence of the given key, or null if there is no mapping for the given key. */
	@Nullable
	...
	/** Returns the key of the <b>first</b> occurrence of the given value, or null if there is no mapping for the given value. */
	@Nullable
	...
	public boolean containsKey(@NotNull K key) { return getValue(key) != null; }
	
	public boolean containsValue(@NotNull V value) { return getKey(value) != null; }
	...
	@NotNull
	public Entry<K, V> getEntry(int index) { return list.get(index); }
	
	@NotNull
	public Iterator<Entry<K, V>> iterator() { return list.iterator(); }
	...
	public void sort(@NotNull Comparator<Entry<K, V>> comparator) {	Collections.sort(list, comparator); }
