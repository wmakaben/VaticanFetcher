...
import net.sourceforge.vaticanfetcher.util.LoopTimer;
...
privileged aspect CodeConventions {
	...
	&& within(net.sourceforge.vaticanfetcher..*): // Ignore external sources
	...
	&& !within(net.sourceforge.vaticanfetcher..Test*)
	&& !within(net.sourceforge.vaticanfetcher..*Test):
